...
対象画像: `selected/xiaolin_016_7df317fc.png`

## note用キャプション案

縁側に座って目を閉じる静かなカット。庭と柱のフレーミングが、内面に向かう時間を作っている。
...
```json
{
  ...
  "scene": {
    "ja": "庭に面した古い道場の縁側",
    "en": "a veranda of an old dojo facing a garden"
  },
  "pose": {
    "ja": "脚を組んで座り、目を閉じて手を膝に置く",
    "en": "sitting cross-legged with eyes closed and hands resting on the knees"
  },
  "intent": {
    "ja": "外の気配を聞きながら、心を静める修練",
    "en": "calming the mind while listening to the presence of the garden outside"
  },
  "composition": {
    "ja": "柱と窓枠で人物を囲み、背景の庭へ視線を抜く",
    "en": "frame the figure with pillars and window frames, letting the eye move into the garden behind"
  },
  "strengths": {
    "ja": [
      "閉じた目の穏やかさ",
    ...
    "en": [
      "peacefulness of the closed eyes",
      "contrast between interior and exterior light",
      "depth in the garden"
    ]
  },
  "motion": {
    "ja": "完全に静止。髪先と衣装に自然な重みを持たせる",
    "en": "completely still, with natural weight in the hair tips and clothing"
  },
  "lighting": {
    "ja": "庭から入る柔らかな自然光と、室内の落ち着いた影",
    "en": "soft natural garden light with calm interior shadows"
  },
  "mood": {
    "ja": "穏やかで内省的な、静の時間",
    "en": "peaceful, introspective, and meditative"
  },
  "style": {
  ...
  "imageFile": "xiaolin_016_7df317fc.png",
  "image": "../../selected/xiaolin_016_7df317fc.png",
  "imageForMarkdown": "selected/xiaolin_016_7df317fc.png",
  "title": "縁側で目を閉じる静かな座法",
...
Create a high-quality anime-style illustration set in a veranda of an old dojo facing a garden. The pose/action is sitting cross-legged with eyes closed and hands resting on the knees, expressing calming the mind while listening to the presence of the garden outside.

Composition: frame the figure with pillars and window frames, letting the eye move into the garden behind. Emphasize peacefulness of the closed eyes, contrast between interior and exterior light, depth in the garden.

Keep completely still, with natural weight in the hair tips and clothing, soft natural garden light with calm interior shadows, and peaceful, introspective, and meditative. The scene should feel quiet, focused, and cinematic rather than chaotic.
...
庭に面した古い道場の縁側を舞台に、脚を組んで座り、目を閉じて手を膝に置く場面を、アニメ調の高品質イラストとして描いてください。外の気配を聞きながら、心を静める修練が伝わるようにしてください。

柱と窓枠で人物を囲み、背景の庭へ視線を抜く。見どころとして、閉じた目の穏やかさ、室内外の明暗差、庭の奥行きを強調してください。

完全に静止。髪先と衣装に自然な重みを持たせる、庭から入る柔らかな自然光と、室内の落ち着いた影、穏やかで内省的な、静の時間を保ってください。場面は混沌とした戦闘ではなく、集中した、映画的で静かな一瞬にしてください。
